...
public class Motorway {
	...
	public static void main(String[] args) {
		...
		// The constructor can now fail, so creation has to be guarded. The
		// compiler enforces this - the exception is checked.
		try {
		...
		} catch (OutOfRegistrationPlatesException e) {
			System.out.println("Cannot start the race: " + e.getMessage());
			return;
		}
